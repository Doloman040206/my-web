...
export async function GET() {
    const response = await fetch("https://api.open-meteo.com/v1/forecast?latitude=48.466111&longitude=35.025278&daily=weather_code&timezone=auto&forecast_days=1")
