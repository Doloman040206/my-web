...
export function CreatePizaForm(props: ICreatePizaFormProps) {
  ...
  const onClickImageBox = () => { if (fileInputRef.current) fileInputRef.current.click(); };
  ...
  const styles = {
    ...
    label: { marginRight: '12px', fontSize: '1.05rem', color: '#222' },
    input: { fontSize: '1.1rem', padding: '10px 12px', borderRadius: '6px', border: '1px solid #e0e0e0', boxSizing: 'border-box' as const },
    imageBox: { fontSize: '1.1rem', padding: '10px 12px', borderRadius: '6px', border: '1px solid #e0e0e0', display: 'flex', alignItems: 'center', cursor: 'pointer', userSelect: 'none' as const, marginRight: '6px' },
  ...
  return (
    <div style={styles.page} className="piza-page">
      <div style={styles.subtitle} className="piza-subtitle">Piza List</div>
      ...
      <div style={styles.formRow} className="form-row">
        <label htmlFor="ingredientsInput" className="form-label" style={styles.label}>Ingredients:</label>
        <input
          id="ingredientsInput"
          className="form-input"
          style={styles.input}
      ...
      <div style={styles.formRow} className="form-row">
    <label htmlFor="priceInput" className="form-label" style={styles.label}>Price:</label>
        <input
          id="priceInput"
          className="form-input"
          style={styles.input}
      ...
      <div style={styles.formRow} className="form-row" >
        <label htmlFor="imageInput" className="form-label" style={styles.label}>Image:</label>
        <div
        ...
        <input
          ...
          style={{ display: 'none' }}
        />
        <button className="add-button" style={styles.addButton} onClick={addItem}>ADD</button>
      </div>
    </div>
  );
}